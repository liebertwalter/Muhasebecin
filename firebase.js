      ...
      ">
        <div style="text-align:center; margin-bottom:16px;">
          <div style="
            ...
            border-radius:20px; background:linear-gradient(135deg,#2f7cff,#1458f4);
        ...
        <div style="display:flex; gap:8px; margin-bottom:14px;">
          <button id="tabLogin" style="flex:1; border:none; border-radius:14px; padding:12px; background:#2563eb; color:#fff; font-weight:800;">Giriş Yap</button>
          <button id="tabRegister" style="flex:1; border:none; border-radius:14px; padding:12px; background:rgba(255,255,255,.08); color:#fff; font-weight:800;">Kayıt Ol</button>
        </div>

        <div id="registerFields" style="display:none;">
          <input id="authUsername" placeholder="Kullanıcı adı" style="width:100%; margin-bottom:10px; padding:14px 16px; border:none; outline:none; border-radius:16px; background:rgba(255,255,255,.08); color:#fff;">
        </div>

        <input id="authLoginValue" placeholder="E-posta veya kullanıcı adı" style="width:100%; margin-bottom:10px; padding:14px 16px; border:none; outline:none; border-radius:16px; background:rgba(255,255,255,.08); color:#fff;">
        <input id="authEmail" placeholder="E-posta (kayıt için)" style="display:none; width:100%; margin-bottom:10px; padding:14px 16px; border:none; outline:none; border-radius:16px; background:rgba(255,255,255,.08); color:#fff;">
        <input id="authPassword" type="password" placeholder="Şifre" style="width:100%; margin-bottom:10px; padding:14px 16px; border:none; outline:none; border-radius:16px; background:rgba(255,255,255,.08); color:#fff;">

        <button id="authSubmitBtn" style="width:100%; border:none; border-radius:16px; padding:14px; background:linear-gradient(135deg,#3e8dff,#1556f0); color:white; font-weight:900; font-size:16px;">Giriş Yap</button>
        <div id="authMessage" style="margin-top:12px; font-size:13px; color:#dbeafe; text-align:center; min-height:18px;"></div>
      </div>
    </div>
  `;
}
